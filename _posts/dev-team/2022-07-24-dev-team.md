...
The question that should echo in the office corner where the developers hang out is **why**.
...
The team gets a better understanding of their product and delivery since there will be no source code and features that are just there without any purpose.
There won't be buttons in the UI which **could** serve as a feature that **maybe** will be implemented in the future.

By keeping the vision well defined and sticking to it, the teams answer the question: _What does your product do?_shows confidence.

	- "Our product does X and Y."
Instead of

	- "Our product does X, maybe Y and probably half o of Z."
